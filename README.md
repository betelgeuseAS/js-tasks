...
**Based on Repository:** [lydiahallie/javascript-questions](https://github.com/lydiahallie/javascript-questions)

![version](https://img.shields.io/badge/version-1.0.0-yellowgreen)
![licence](https://img.shields.io/badge/license-MIT-brightgree)
![repo size](https://img.shields.io/github/repo-size/betelgeuseAS/js-questions.svg)


From basic to advanced: test how well you know JavaScript, refresh your knowledge a bit, or prepare for your coding interview :muscle:! Answers have been added to the **collapsed sections** below the questions, just click on them to expand :rocket:.

---

<details>
<summary><b> See 19 Available Translations 🇸🇦🇪🇬🇧🇦🇩🇪🇪🇸🇫🇷🇮🇩🇯🇵🇰🇷🇳🇱🇧🇷🇷🇺🇹🇭🇹🇷🇺🇦🇻🇳🇨🇳🇹🇼</b></summary>
<p>
