// Хитрість: IIFE (Immediately Invoked Function Expression).
(function () {
  (function () {
    // …
  })();
...
// Завдання: який варіант створення об'єкта не вірний?
(function () {
...
// Завдання: у якого оператора із перерахованих найвищий пріоритет?
(function () {
  // 1. Присвоєння =
...
// Завдання: що видасть перший та другий блок коду?
(function () {
  // 1 блок коду
  // let return = 5;
  // let for = 'Hi';
...
// Хитрість: вимкнути логування console.
(function () {
